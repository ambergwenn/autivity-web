            ...
            {cardItems.map((card, index) => {
                ...
                return (
                    <motion.div
                        ...
                        className={`group relative flex flex-col justify-between overflow-hidden rounded-3xl border-[3px] ${card.borderColor} ${card.upperBg || "bg-white"} shadow-sm transition-colors duration-300 hover:shadow-xl ${card.shadowColor} cursor-pointer min-h-[220px]`}
                    >
                        {/* Top Section */}
